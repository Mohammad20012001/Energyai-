                  ...
                  <div className="space-y-2">
                      <h4 className="font-semibold text-muted-foreground">الظروف البيئية للموقع</h4>
                       <div className="grid grid-cols-2 gap-2">
                          ...
                          <FormField control={form.control} name="maxTemp" render={({field}) => (<FormItem><FormLabel>أقصى حرارة صيفًا (°C)</FormLabel><FormControl><Input {...field} /></FormControl><FormMessage /></FormItem>)}/>
                      </div>
                  </div>
